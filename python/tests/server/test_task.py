...
@pytest.mark.parametrize(
    ...
    [
        ...
        lambda t: t.update(examples=[{"item": "x", "category_id": "nope"}]),
        lambda t: t.update(examples=[{"item": "", "category_id": "question"}]),
    ...
    ids=[
        ...
        "reserved_expected_value", "reserved_id", "schema_version", "unknown_field",
